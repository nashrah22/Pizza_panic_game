# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 14:37:53 2022
...
class Pan(games.Sprite):
    ...
    """
    image = games.load_image("bowl.bmp")
...
class Pizza(games.Sprite):
    ...
    """
    image = games.load_image("pizza6.bmp")
    speed = 1
...
class Chef(games.Sprite):
    ...
    """
    image = games.load_image("chef2.bmp")
...
def main():
    """ Play the game. """
    wall_image = games.load_image("sky_wall2.jpg", transparent = False)
